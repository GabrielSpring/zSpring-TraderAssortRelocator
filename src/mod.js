...
exports.mod = void 0;
const fluentTraderAssortCreator_1 = require("../src/fluentTraderAssortCreator");
class Mod {
    fluentAssortCreator;
    logger;
    VanillaItems = require("../db/items.json");
    Config = require("../config/config.json");
    VanillaTraders = ["5a7c2eca46aef81a7ca2145d", // Mechanic
    ...
    returnParent(logger, tables, tpl) {
    ...
    preSptLoad(container) {
        ...
        this.fluentAssortCreator = new fluentTraderAssortCreator_1.FluentAssortConstructor(hashUtil, logger);
    }
